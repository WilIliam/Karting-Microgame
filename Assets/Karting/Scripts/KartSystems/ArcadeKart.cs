...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public GameObject m_VfxSmoke;
        public bool m_vfxActive = false;
        ...
        List<Stats> m_ActiveSpeedList = new List<Stats>();
        ...
        public void AddSpeedup(Stats stats) => m_ActiveSpeedList.Add(stats);
